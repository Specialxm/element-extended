...
import { isActive } from '../../../../../../../vue/3.0/element-plus/docs/.vitepress/vitepress/utils'
...
export function usePageNav() {
  ...
  const candidates = computed(() => {
    const config = getSidebarConfig(theme.value.sidebars, page.value.relativePath, lang.value)
